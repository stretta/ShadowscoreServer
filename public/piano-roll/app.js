...
const state = { score:null, snapshot:null, draft:null, clipId:"", selected:-1, dirty:false, stale:false, chasing:false, folded:false, drag:null, playback:null, playbackGeneration:0, playbackRequest:null, rnboTargets:[], timingContracts:[], dpr:Math.max(1,devicePixelRatio||1), left:58, top:22, minPitch:36, maxPitch:84 };
